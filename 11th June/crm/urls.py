...
urlpatterns = [
    ...
    path('worksheetedit',views.worksheetedit,name='worksheetedit'),
    path('customeredit',views.customeredit,name='customeredit'),
    path('renewaledit',views.renewaledit,name='renewaledit'),
    path('credentialedit',views.credentialedit,name='credentialedit'),
